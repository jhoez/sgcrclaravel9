            ...
            <div class="overflow-hidden">
              ...
              <table class="min-w-full">
                <thead class="border-b bg-cyan-500">
                  <tr>
                    <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Nombre de Proyecto</th>
                    <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">CBIT</th>
                    <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Tipo de Multimedia</th>
                    <th scope="col" class="text-sm font-medium text-gray-900 px-6 py-4 text-left">Archivo multimedia</th>
